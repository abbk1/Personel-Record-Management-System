                ...
                <!-- /.row -->
                 <?php
                    ...
                    if(empty($password)){
                        ...
                        $query = "UPDATE `tblusers` SET `firstname`='$firstname', `lastname`='$lastname', `othername`='$othername', ";
                        $query .= " `gender`='$gender', `phonenumber`='$phonenumber', `email`='$email', `username`='$username', `password`='$password', ";
                        $query .= " `user_role`='$user_role' WHERE user_id = $id";
                        ...
                        if(!$execute_query){
                         ...
                         header('Location: view_users.php?edit=success');
                    }
        
                    }

                    if (isset($_GET['edit'])) {
                        $user_id = escapeString($_GET['edit']);
                        ...
                        <form role="form" method="post" action="edit_user.php">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" value="<?= (isset($user_id)) ? $user_id : ''; ?>" name="id">
